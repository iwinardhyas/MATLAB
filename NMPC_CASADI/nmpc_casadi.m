...
for k = 0:N-1
    ...
    ubw = [ubw; 10*ones(nu,1)];  % Batas atas gaya dorong motor (misal, 10N)
    w0 = [w0; zeros(nu,1)];
    ...
    Q = diag([100, 100, 100, 10, 10, 10, 1, 1, 1, 0.1, 0.1, 0.1]); % Bobot error state
...
for i = 1:N_sim
    ...
    x_ref_at_current_time = QuadrotorReferenceTrajectory(current_time);
    ...
    actual_params = [current_state; x_ref_at_current_time]; % Gunakan referensi yang diperbarui
    % Panggil solver
