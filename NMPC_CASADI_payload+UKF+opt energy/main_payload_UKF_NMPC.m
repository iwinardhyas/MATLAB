...
for i = 1:N_sim_total
    ...
    if mod(round(current_time/dt_nmpc)*dt_nmpc, dt_nmpc) < (dt_ukf/2) % Jalankan NMPC pada kelipatan dt_nmpc
        ...
        x_ref_for_nmpc = QuadrotorReferenceTrajectory4(current_time, nominal_mass_value);
    ...
    history_x_ref(:,i) = QuadrotorReferenceTrajectory4(current_time, nominal_mass_value); % Log referensi
...
history_x_ref(:,N_sim_total+1) = QuadrotorReferenceTrajectory4(T_sim, nominal_mass_value); % Log referensi terakhir
