...
%     arg_w0 = [arg_w0; thrust_hover_value*ones(nu,1)]; % Initialize at hover
    ...
    for m = 1:M-1
        ...
        x_guess = full(F_sub(x_guess, thrust_hover_value*ones(nu,1), wind_param(:, k+1)));
%         arg_w0 = [arg_w0; x_guess];
    ...
    ubw = [ubw; inf*ones(nx,1)];
%     w0 = [w0; zeros(nx,1)];
    w_input = zeros(n_wind,1);
    x_guess = full(F_discrete(x_guess, thrust_hover_value*ones(nu,1),w_input));
%     arg_w0 = [arg_w0; x_guess];
