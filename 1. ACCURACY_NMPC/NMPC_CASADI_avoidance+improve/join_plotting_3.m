...
subplot(2,3,1);
hold on;
plot(t_single, results_single.history_x(1,:), 'Color', color1, 'LineWidth', 1.5);
plot(t_multi, results_multi.history_x(1,:), 'Color', color2, 'LineWidth', 1.5);
plot(t_multi3, results_multi3.history_x(1,:), 'Color', color3, 'LineWidth', 1.5);
plot(t_single, results_single.history_x_ref(1,:), 'k--', 'LineWidth', 1.5);
grid on;
xlabel('Time (s)');
ylabel('Position X (m)');
legend('Hybrid', 'Cost-only', 'Parameter-level APF','Reference X', 'Location','best');
...
subplot(2,3,2);
hold on;
plot(t_single, results_single.history_x(2,:), 'Color', color1, 'LineWidth', 1.5);
plot(t_multi, results_multi.history_x(2,:), 'Color', color2, 'LineWidth', 1.5);
plot(t_multi3, results_multi3.history_x(2,:), 'Color', color3, 'LineWidth', 1.5);
plot(t_single, results_single.history_x_ref(2,:), 'k--', 'LineWidth', 1.5);
grid on;
xlabel('Time (s)');
ylabel('Position Y (m)');
legend('Hybrid', 'Cost-only', 'Parameter-level APF', 'Reference Y', 'Location','best');
...
subplot(2,3,3);
hold on;
plot(t_single, results_single.history_x(3,:), 'Color', color1, 'LineWidth', 1.5);
plot(t_multi, results_multi.history_x(3,:), 'Color', color2, 'LineWidth', 1.5);
plot(t_multi3, results_multi3.history_x(3,:), 'Color', color3, 'LineWidth', 1.5);
plot(t_single, results_single.history_x_ref(3,:), 'k--', 'LineWidth', 1.5);
grid on;
xlabel('Time (s)');
ylabel('Position Z (m)');
legend('Hybrid', 'Cost-only', 'Parameter-level APF', 'Reference Z', 'Location','best');
...
subplot(2,3,4);
hold on;
plot(t_single, results_single.history_x(4,:), 'Color', color1, 'LineWidth', 1.5);
plot(t_multi, results_multi.history_x(4,:), 'Color', color2, 'LineWidth', 1.5);
plot(t_multi3, results_multi3.history_x(4,:), 'Color', color3, 'LineWidth', 1.5);
plot(t_single, results_single.history_x_ref(4,:), 'k--', 'LineWidth', 1.5);
grid on;
xlabel('Time [s]');
ylabel('Phi angle [rad]');
legend('Hybrid', 'Cost-only', 'Parameter-level APF', 'Reference', 'Location','best');
...
subplot(2,3,5);
hold on;
plot(t_single, results_single.history_x(5,:), 'Color', color1, 'LineWidth', 1.5);
plot(t_multi, results_multi.history_x(5,:), 'Color', color2, 'LineWidth', 1.5);
plot(t_multi3, results_multi3.history_x(5,:), 'Color', color3, 'LineWidth', 1.5);
...
subplot(2,3,6);
hold on;
plot(t_single, results_single.history_x(6,:), 'Color', color1, 'LineWidth', 1.5);
plot(t_multi, results_multi.history_x(6,:), 'Color', color2, 'LineWidth', 1.5);
plot(t_multi3, results_multi3.history_x(6,:), 'Color', color3, 'LineWidth', 1.5);
...
xline(4, '--', 'Avoidance Start', 'Color', [0.5 0.5 0.5], 'LabelVerticalAlignment','bottom');
xline(9, '--', 'Avoidance End', 'Color', [0.5 0.5 0.5], 'LabelVerticalAlignment','bottom');

legend({'Hybrid NMPC (Cost + Constraint)', ...
        'NMPC (Cost-only APF)', ...
        'NMPC (Input-Bias APF)'}, ...
        'Location','best');
set(gca,'FontSize',11);
...
legend({'Hybrid NMPC', 'Cost-only APF', 'Input-Bias APF'}, 'Location','best');
set(gca,'FontSize',11);
...
fprintf('---------------------------------------------------------------------------------\n');
fprintf('%-35s %-15.3f %-15.3f %-15.3f\n', 'Hybrid NMPC (Cost+Constraint)', J_u_single, mean_u_single, max_u_single);
fprintf('%-35s %-15.3f %-15.3f %-15.3f\n', 'NMPC (Cost-only APF)',         J_u_multi,  mean_u_multi,  max_u_multi);
fprintf('%-35s %-15.3f %-15.3f %-15.3f\n', 'NMPC (Input-Bias APF)',        J_u_multi3, mean_u_multi3, max_u_multi3);

%% === (Optional) Convert metrics to table for plotting/export ===
ControlEffortTable = table( ...
    {'Hybrid (Cost+Constraint)'; 'Cost-only APF'; 'Input-Bias APF'}, ...
...
h_actual_single = plot3(x_actual_single, y_actual_single, z_actual_single, 'Color', color1, 'LineWidth', 1.5, 'DisplayName', 'Hybrid');

% Plot lintasan metode kedua (Multi)
h_actual_multi = plot3(x_actual_multi, y_actual_multi, z_actual_multi, 'Color', color2, 'LineWidth', 1.5, 'DisplayName', 'Cost-only');

% Plot lintasan metode kedua (Multi)
h_actual_multi3 = plot3(x_actual_multi3, y_actual_multi3, z_actual_multi3, 'Color', color3, 'LineWidth', 1.5, 'DisplayName', 'Parameter-level APF');
...
h_arrow_single = plot3(nan, nan, nan, 'Color', color1, 'LineWidth', 1.5, 'DisplayName', 'Hybrid');
h_arrow_multi = plot3(nan, nan, nan, 'Color', color2, 'LineWidth', 1.5, 'DisplayName', 'Cost-only');
h_arrow_multi3 = plot3(nan, nan, nan, 'Color', color3, 'LineWidth', 1.5, 'DisplayName', 'Parameter-level APF');
...
%% --- Legend (informatif) ---
legend([h_actual_single, h_actual_multi, h_actual_multi3, h_ref, h_arrow_single, h_arrow_multi, h_arrow_multi3, h_obs, h_start_ref, h_finish_ref], 'Location','bestoutside');
...
h_actual_single = plot(x_actual_single, y_actual_single, 'Color', color1, 'LineWidth', 1.5, 'DisplayName', 'Hybrid'); % Jalur Single-NMPC
h_actual_multi = plot(x_actual_multi, y_actual_multi, 'Color', color2, 'LineWidth', 1.5, 'DisplayName', 'Cost-only'); % Jalur Multi-NMPC
h_actual_multi3 = plot(x_actual_multi3, y_actual_multi3, 'Color', color3, 'LineWidth', 1.5, 'DisplayName', 'Parameter-level APF'); % Jalur Multi-NMPC
...
h_obs = plot(nan, nan, 's', 'MarkerFaceColor', obstacle_color, 'MarkerEdgeColor', 'k', 'DisplayName', 'Rintangan Fisik');
h_safe = plot(nan, nan, 'k:', 'LineWidth', 1.2, 'DisplayName', ['Zona Aman (R_{safe} = ' num2str(d_safe) 'm)']);
...
h_arrow_single = plot(nan, nan, 'Color', color1, 'LineWidth', 1.5, 'DisplayName', 'Hybrid');
h_arrow_multi = plot(nan, nan, 'Color', color2, 'LineWidth', 1.5, 'DisplayName', 'Cost-only');
h_arrow_multi3 = plot(nan, nan, 'Color', color3, 'LineWidth', 1.5, 'DisplayName', 'Parameter-level');
...
legend([h_dist_hybrid, h_dist_cost_only, h_dist_input_bias], ...
       {'Hybrid NMPC (Cost+Constraint)', ...
        'NMPC (Cost-only APF)', ...
        'NMPC (Input-Bias APF)'}, ...
       'Location', 'northeast', 'FontSize', 10, 'Box', 'off');
   
xline(1.2, '--', 'Start Avoidance', 'Color', [0.2 0.2 0.2]);
xline(10.6, '--', 'End Avoidance', 'Color', [0.2 0.2 0.2]);
...
legend([h_speed_hybrid, h_speed_cost_only, h_speed_input_bias], ...
       {'Speed (Hybrid NMPC)', 'Speed (Cost-only APF)', 'Speed (Input-Bias APF)'}, ...
       'Location', 'best');
...
for i = 1:3
    ...
    legend([h_ref, h_single, h_multi], 'NMPC reference', 'Actual (Hybrid)', 'Actual (Cost-only)', 'Actual (Parameter-level APF)', 'Location', 'best');
...
xlabel('Time [s]');
ylabel('Speed [m/s]');
legend('NMPC reference speed', 'Actual speed (Hybrid)', 'Actual speed (Cost-only)', 'Actual speed (Parameter-level APF)', 'Location', 'best');
...
%% === Buat Tabel Evaluasi ===
Method = {'APF-Cost-only'; 'APF-Hybrid (Cost+Constraint)'; 'APF-Parameter-level'};
