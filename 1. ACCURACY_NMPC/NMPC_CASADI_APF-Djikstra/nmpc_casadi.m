...
N = 50; % Kurangi horizon untuk konvergensi lebih baik
dt = 0.02; % Time step lebih kecil
...
for k = 0:N-1
    ...
    Q = diag([200, 200, 300, ... % px, py, pz
                   50, 50, 30, ...   % phi, theta, psi
                   10, 10, 15, ...      % vx, vy, vz
                   1, 1, 1]);  % p, q, r
...
%     Q = diag([5.5350,    0.9021,    6.3832,    1.9310,    5.7350,    5.3354,    9.6683,    0.0412,    3.8418,    7.8654,    7.9072,    3.2907]);    % p, q, r (rate, cukup rendah)
% 
%     R = diag([0.4410,    6.0599,    0.0729,    8.8694]); % penalti kontrol kecil agar NMPC agresif
