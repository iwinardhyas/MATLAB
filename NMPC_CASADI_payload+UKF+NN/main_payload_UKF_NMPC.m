...
solver_nmpc = nlpsol('solver_nmpc', 'ipopt', nlp, solver_options);
...
for i = 1:N_sim_total
    ...
    history_x_ref(:,i) = QuadrotorReferenceTrajectory1(current_time, nominal_mass_value); % Log referensi
...
history_x_ref(:,N_sim_total+1) = QuadrotorReferenceTrajectory1(T_sim, nominal_mass_value); % Log referensi terakhir
