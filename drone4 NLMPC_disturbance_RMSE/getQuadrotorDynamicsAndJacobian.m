...
mean_wind = 0;         % Mean (bias) noise
std_dev_wind = 1;    % Standard deviation

% Parameter noise Gaussian
mean_torque = 0;         % Mean (bias) torque noise
std_dev_torque = 0.01;   % Standard deviation
...
f(10:12) = J/(tau_beta - C*[phidott(t); thetadott(t); psidott(t)]);
