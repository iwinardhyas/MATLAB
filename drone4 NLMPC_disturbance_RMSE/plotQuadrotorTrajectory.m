...
subplot(3,4,10)
hold on
plot(time,RMSEHistoryx)
grid on
xlabel('time')
ylabel('m')
legend('RMSE x Position','Location','southeast')
title('RMSE x Position')

subplot(3,4,11)
hold on
plot(time,RMSEHistoryy)
grid on
xlabel('time')
ylabel('m')
legend('RMSE y Position','Location','southeast')
title('RMSE y Position')

subplot(3,4,12)
hold on
plot(time,RMSEHistoryz)
grid on
xlabel('time')
ylabel('m')
legend('RMSE z Position','Location','southeast')
title('RMSE z Position')
